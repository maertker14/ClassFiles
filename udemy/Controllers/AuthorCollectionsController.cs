...
namespace RESTfulAPICourse.Controllers
{
    ...
    public class AuthorCollectionsController : ControllerBase
    {
        ...
        public IActionResult GetAuthorCollection(
            [FromRoute]
            [ModelBinder(BinderType = typeof(ArrayModelBinder))]  IEnumerable<Guid> ids)//by default it looks in the body so we have to say FromRoute
        {
            if (ids == null)
            {
                return BadRequest();
        ...
        public ActionResult<IEnumerable<AuthorDto>> CreateAuthorCollection(IEnumerable<AuthorForCreationDto> authorCollection)
        {
            ...
            {
                _courseLibraryRepository.AddAuthor(entity);
            }
